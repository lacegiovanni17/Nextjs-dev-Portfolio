          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <p className="my-4 text-base font-medium">
                My name is Chidike Henry Chizoba, As a skilled full-stack
                software developer, I specialize in software development,
                offering innovative and reliable technology solutions for
                start-ups and established businesses. With a strong focus on
                delivering business-critical software systems, I bring years of
                experience and expertise to the table. Explore my latest
                projects and articles, showcasing my expertise in React.js, web
